...
type kLogServiceClient struct {
	*kClient
}

func (p *kLogServiceClient) Search(ctx context.Context, req *es_log.SearchRequest, callOptions ...callopt.Option) (r *es_log.SearchResponse, err error) {
